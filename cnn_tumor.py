...
plt.savefig('results/tumor_sample_accuracy_plot.png')
...
plt.savefig('results/tumor_sample_loss_plot.png')
...
model.save('results/model/cnn_tumor.keras')
...
make_prediction(cv2.imread('/home/redleaf/Documents/DUK/Deep Learning/deep-learning/CNN/tumor_detection/tumordata/yes/y6.jpg'),model)
print("--------------------------------------\n")
make_prediction(cv2.imread('/home/redleaf/Documents/DUK/Deep Learning/deep-learning/CNN/tumor_detection/tumordata/no/no1.jpg'),model)
print("--------------------------------------\n")
